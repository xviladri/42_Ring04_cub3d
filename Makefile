...
#    Updated: 2026/03/09 19:33:53 by xviladri         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
NAME        = cub3D
CC          = cc
...
SRC_DIR     = src
OBJ_DIR     = obj
SRC_FILES   = main.c close_program.c parsing/parse_cub.c parsing/map_textures.c parsing/parse_colors.c parsing/map.c parsing/map_checks.c parsing/map_walls.c parsing/flood_fill.c render/render.c render/render_utils.c render/map.c utils/ray_map.c moves/player_move.c moves/key_hooks.c render/textures.c
