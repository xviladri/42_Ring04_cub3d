...
### 📚 Resources
  ...
  * **AI Usage Disclaimer:** As per the 42 curriculum guidelines, Artificial Intelligence was used critically as a tutoring tool to understand complex mathematical concepts (like trigonometric calculations for raycasting) and to help structure the code logic. No AI-generated code was blindly copy-pasted; all code was thoroughly reviewed, understood, and typed by the authors. Also, AI was used to create the amazing .xpm photos.
